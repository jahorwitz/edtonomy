    ...
    <div className="profile">
      <div className="profile__container">
        ...
        <ol className="profile__list">
          ...
          <li>
            Fill out your profile: Depending on the platform you're using, you
            may have the option to add additional information such as your
            education, work experience, skills, and contact information.{" "}
          </li>
          <li>
            Customize your profile: Make your profile stand out by customizing
            it with colors, fonts, and images that reflect your personality or
            brand.
          </li>
        </ol>
